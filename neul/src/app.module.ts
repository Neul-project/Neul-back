...
@Module({
  imports: [
    ...
    TypeOrmModule.forRoot({ // TypeORM 설정 (db 연결)
      ...
      entities: [Users, Patients, UserCheck, Activities, Feedback, Programs, Pay, Refund, Status, Chats, Match, Banners, ChatRoom, Cart, Alert, PayPrograms, Helper, Apply, Shift],
      charset: 'utf8mb4',
      synchronize: true,
    }),
