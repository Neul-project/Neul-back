...
export class MailService {
    ...
    async sendEmail(checkEmail: string){
        ...
        const mailOptions = { // 이메일 전송
            ...
            subject: '[NEUL 인증메일]',
            html: `
                <table width="600" cellpadding="0" cellspacing="0" style="margin: 0 auto; background-color: #f9f9f9; overflow: hidden; font-family: Arial, sans-serif; border-collapse: collapse;">
                    <tr>
                        <td style="padding: 30px; text-align: center; boarder: 1px solid #000000;">
                    ...
                    <tr>
                    <td style="background-color: #ffffff; text-align: center; padding: 20px; boarder: 1px solid #000000;">
